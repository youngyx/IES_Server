...
enum
{
	...
	MSP_ERROR_FLASH_NETWORK_CONNECT_FIALED  =19000,						/*flash网络连接失败*/
	MSP_ERROR_FLASH_NETWORK_CHECK_FIALED    =19001,						/*flash网络检测失败*/
	MSP_ERROR_FLASH_NETWORK_CHECK_TIMEOUT   =19002,						/*flash网络检测超时*/
};
